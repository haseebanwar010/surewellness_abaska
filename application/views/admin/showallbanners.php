        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">All Banners With Details</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
//echo $path_parts['extension'];                       
                ...
                <td>
    <a href="<?php echo base_url('admin/Showallbanners/edit/'.$record->id); ?>" class="btn btn-info">Edit</a>
...
<a href="<?php echo base_url('admin/Showallbanners/delete/'.$record->id); ?>" id="btnYes" class="btn btn-danger">Yes! Delete it.</a> 
        <a ></a>
      </div>
    </div>
  </div>
