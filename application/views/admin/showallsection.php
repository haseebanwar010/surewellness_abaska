          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <td><?php 
                if($record->section_id==0)
                {echo 'Senior Home Search';}
                elseif($record->section_id==1)
                {echo 'Home Providers';}
                ?></td>
                
                <td>
                <a href="<?php echo base_url('admin/Showallsections/edit/'.$record->id); ?>" class="btn btn-info">Edit</a>
                <a href="#" class="btn btn-danger" data-toggle="modal" data-target="#exampleModal<?php echo $record->id; ?>">Delete</a>
<!--                <a href="<?php echo base_url('admin/Showallsections/delete/'.$record->id); ?>" class="btn btn-danger">Delete</a>-->
                </td>
...
<a href="<?php echo base_url('admin/Showallsections/delete/'.$record->id); ?>" id="btnYes" class="btn btn-danger">Yes! Delete it.</a> 
        <a ></a>
      </div>
    </div>
  </div>
