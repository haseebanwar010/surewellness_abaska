...
<!--        <small>Control panel</small>-->
    ...
    <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Home Provider|Add Banner Section</h3>
...
<div class="box-body">
    <form method="post" action="<?php echo base_url('admin/bannersectionprovider/addprovidersection') ?>" enctype="multipart/form-data">
        <input type="hidden" name="hiddensection" value="1" />
           <div class="row"> 
            <div class="col-md-6">
