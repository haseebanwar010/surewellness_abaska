...
<div class="job_container job_container1">
		...
		<div class="row">
			<div class="col-sm-12">
				...
				<h3><?php echo $management[0]['title']; ?></h3>
			...
			<div class="managemnt">
					...
					<div class="managemnt_picture" style="background-image: url(<?php echo $baseUrl; ?>uploads/<?php echo $management[0]['image']; ?>);"></div>
					...
					<div class="managemnt_txt">
						<?php echo $management[0]['description']; ?>
					</div>
			</div>
