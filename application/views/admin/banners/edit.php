                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="section_id">
                            <option <?php if($banners[0]['section_id']==1){ echo "selected"; } ?> value="1">Searching For Homes</option>
                            <option <?php if($banners[0]['section_id']==2){ echo "selected"; } ?> value="2">Home Providers</option>
                        </select>
                    </div>
                </div>
                <div class="col-lg-6">
