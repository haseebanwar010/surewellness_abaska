            ...
            <div class="box-body">
              <form id="" role="form" method="post" action="<?php echo $baseUrl; ?>admin/settings/edit/<?php echo $settings[0]['id']; ?>" enctype="multipart/form-data">
                ...
                <!-- text input -->
                 ...
                 <div class="col-md-6">
                    <div class="form-group">
                    	<label for="f_name">Phone (1)</label>
                        <input type="text"  class="form-control" value="<?php echo $settings[0]['phone']; ?>"  id="phone" name="phone" placeholder="">
                    </div>
                </div>
                  <div class="col-md-6">
                    <div class="form-group">
                    	<label for="f_name">Phone (2)</label>
                        <input type="text"  class="form-control" value="<?php echo $settings[0]['phone2']; ?>"  id="phone2" name="phone2" placeholder="">
                    </div>
                </div>
                  <div class="col-md-6">
                    <div class="form-group">
                    	<label for="f_name">Fax</label>
                        <input type="text"  class="form-control" value="<?php echo $settings[0]['fax']; ?>"  id="fax" name="fax" placeholder="">
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                    	<label for="f_name">Availability</label>
                       <input type="text"  class="form-control" value="<?php echo $settings[0]['availability']; ?>"  id="availability" name="availability" placeholder="">
                    </div>
                </div>
                  <div class="col-md-6">
                    <div class="form-group">
