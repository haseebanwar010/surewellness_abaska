...
</div><div class="job_container job_container1">
		<div class="container">
		<div class="row">
			<div class="col-sm-12">
				<div class="inner_page_heading">
				<h3><?php echo $staffing[0]['title']; ?></h3>
			...
			<div class="managemnt">
					...
					<div class="mangagemnt_pic_box">
					<div class="managemnt_picture" style="background-image: url(<?php echo $baseUrl; ?>uploads/<?php echo $staffing[0]['image']; ?>);"></div>
					...
					<div class="managemnt_txt">
						<?php echo $staffing[0]['description']; ?>
					</div>
			</div>
