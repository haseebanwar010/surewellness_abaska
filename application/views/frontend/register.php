...
<div class="row">
			...
			<div class="col-sm-12">
				<div class="reigster">
						<form action="<?php echo base_url('registers/add'); ?>" id="employee_from" class="register-box register_box_margin" method="post" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="form-st-rp">
                        <div class="form-wrp lefts">
                            ...
                            <input type="text" placeholder="First Name" name="first_name" class="register-form alpha-only ">

                        </div>
                        <div class="form-wrp rights">

                            <label>Middle Name<span class="mendiatory">*</span> </label>
                            <input type="text" placeholder="Middle Name"  name="middle_name" class="register-form alpha-only ">
                    ...
                    <div class="form-st-rp">
                         <div class="form-wrp lefts">
                            ...
                            <input type="text" placeholder="Last Name"  name="last_name" class="register-form alpha-only">

                        </div>
                          <div class="form-wrp rights">

                            <label>Address <span class="mendiatory">*</span> </label>
                            <input type="text" placeholder="Address"  class="register-form" name="address">
                                                           </div>
                        ...
                        <div class="form-wrp lefts query-form-top ">
                             ...
                             <div class="company-field ">
                                    <select id="state_id" name="state" class="form-control select2 state_changer" style="width:100%;" onChange="change_city();" >
                        ...
                        <div class="form-wrp rights query-form-top">
                            ...
                            <label>City <span class="mendiatory">*</span></label>
                             <div class="company-field ">
                                    <select class="form-control city_changer select2" id="city_id" name="city" style="width:100%;">
                        ...
                        <div class="form-wrp lefts">
                            ...
                            <input type="text" placeholder="Social Security Number"  class="register-form" name="ssn">
                        </div>
                                 <div class="form-wrp rights">

                            <label>Email <span class="mendiatory">*</span> </label>
                            <input type="email" placeholder="Email"  class="register-form" name="email">
                                                           </div>
                    </div>    
                             <div class="form-st-rp">
                                  <div class="form-wrp lefts">
                        ...
                        <input type="password" placeholder="Password" id="password" name="password" class="register-form" >
                        </div>
                                 <div class="form-wrp rights">


                            <label>Home Phone <span class="mendiatory">*</span> </label>
                            <input type="text"  placeholder="Home Phone"  id="home_phone" name="home_phone" class="register-form">
                        ...
                        <input type="text"  placeholder="Cell Phone" id="cell_phone" name="cell_phone" class="register-form">
                            ...
                            <input type="text"  placeholder="Work Phone" id="work_phone" name="work_phone" class="register-form">
                        ...
                        <div class="form-wrp lefts">
                            ...
                            <input type="text"  placeholder="Emergency Contact" id="emergency_contact" name="emergency_contact" class="register-form">
                        </div>
                               <div class="form-wrp rights">
                    ...
                    <input type="text" placeholder="Date Of Birth"  name="dob" class="register-form datepicker">
                        </div>
                                <div class="form-wrp rights">
                            <label>Languages Spoken</label>
                            <input type="text"  placeholder="Languages Spoken"  id="languages" name="languages" class="register-form">
                        </div>
                        </div>
                        <div class="form-st-rp">
                            <div class="form-wrp lefts">
                            ...
                            <input type="text"  placeholder="How did you find out about our company?"  id="how_find_company" name="how_find_company" class="register-form">
                        </div>
                                <div class="form-wrp rights">
                            <label>Which cities would you prefer to work in?</label>
                            <input type="text"  placeholder="Which cities would you prefer to work in?" id="work_city" name="work_city" class="register-form">
                        </div>
                            ...
                            <label>Are you currently able to perform the essential functions, with or without a reasonable accommodation, for   the position for which you are applying?</label>
                                    <textarea class="class=register-form" name="essential_functions"></textarea>
                            ...
                            <label>Have you previously worked for our company? </label>
                                    <textarea class="class=register-form" name="previously_worked"></textarea>
