      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Update Section</li>
          ...
          <section class="content">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form id="" role="form" method="post" action="<?php echo $baseUrl; ?>admin/sections/edit/<?php echo $section['id']; ?>/<?php echo $sectionid; ?>" enctype="multipart/form-data">
               ...
               <div class="col-lg-6">
                    <div class="form-group">
                        <label>Title</label>
                        <input value="<?php echo $section['title']; ?>" name="title" type="text" class="form-control" placeholder="Enter Section Title">
                    </div>
                </div>
                <div class="col-lg-6">
                   ...
                   <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <textarea id="editor1" class="form-control" name="description" placeholder="Enter Section Description"><?php echo $section['description']; ?></textarea>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="form-group">
