...
<script>
  ...
  <title>Surewellness | Dashboard</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo $baseUrl; ?>" class="logo">
      ...
      <span class="logo-lg"><b>Admin</b> Surewellness</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo $baseUrl; ?>assets/dist/img/logosure.jpg" class="user-image" alt="User Image">
              <span class="hidden-xs">Surewellness-Admin</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo $baseUrl; ?>assets/dist/img/logosure.jpg" class="img-circle" alt="User Image">
